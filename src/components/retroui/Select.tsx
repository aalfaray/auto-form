...
const SelectTrigger = ({ className, children, ...props }: SelectPrimitive.SelectTriggerProps) => {
  return (
    <SelectPrimitive.Trigger
      className={cn(
        'flex h-9 min-w-40 items-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] justify-between border-2 border-black bg-transparent px-3 py-1 text-sm placeholder:text-muted-foreground outline-none focus:outline-none focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
        className
      )}
      {...props}
    >
